// COPY of the website's src/utils/propertySlug.js — the server must produce exactly the same slugs.
// Keep the two files in sync (see backend/README.md). Readable property URLs: /property/sea-facing-3bhk-apartment instead of /property/p6.
//
 ...
 */
export function slugCandidates(property) {
...
/** Sync version (used by tests and by the seed): first free candidate, then base-2, base-3… */
