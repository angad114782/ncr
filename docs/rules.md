...
1. **Never wall content behind a login.** Pages stay open (visitors and Googlebot). Sign-up is invited at moments of real interest — viewed 2+ homes, a search, a saved home — through `LoginNudge`, `RecommendedForYou` and the sign-up sheet, never a blocking modal.
